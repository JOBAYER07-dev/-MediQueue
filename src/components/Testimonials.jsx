      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {testimonials.map((t, i) => (
            <div
              key={i}
              className="bg-[#131829] border border-white/[0.07] rounded-2xl p-7 flex flex-col hover:border-[#d4a84b]/20 transition-all duration-300"
            >
              {/* Quote mark */}
              ...
              {/* Quote text */}
              <p className="text-[0.82rem] text-[#9aa3be] leading-[1.8] font-light mb-7 flex-1">
                {t.quote}
              </p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-[0.84rem] font-semibold text-[#e8ecf4]">
                    {t.name}
                  </div>
                  <div className="text-[0.7rem] text-[#6b7694] mt-0.5">
                    {t.role}
                  </div>
                </div>
              </div>
