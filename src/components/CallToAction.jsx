...
const CallToAction = () => {
  return (
    <section className="bg-[#0f1424] px-4 sm:px-8 lg:px-16 py-24 relative overflow-hidden">
      {/* ── BG GLOW ── */}
      ...
      <div className="max-w-2xl mx-auto text-center relative z-10">
        ...
        {/* Heading */}
        <h2 className="font-serif text-[clamp(2rem,4vw,3rem)] font-bold tracking-[-0.5px] leading-[1.12] text-[#e8ecf4] mb-5">
          Ready to <em className="italic text-[#d4a84b]">Start?</em>
        </h2>

        {/* Subtitle */}
        <p className="text-[0.9rem] text-[#9aa3be] leading-[1.75] mb-10">
