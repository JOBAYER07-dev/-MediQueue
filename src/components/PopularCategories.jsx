...
const PopularCategories = () => {
  ...
  return (
    <section className="bg-[#0f1424] px-4 sm:px-8 lg:px-16 py-20">
            ...
            return (
              <button
                ...
                className={`flex items-center gap-4 px-5 py-4 rounded-2xl border text-left transition-all duration-200 cursor-pointer w-full
                  ${
                    isActive
                      ? 'bg-[rgba(212,168,75,0.1)] border-[#d4a84b]'
                      : 'bg-[#131829] border-white/[0.07] hover:border-[#d4a84b]/30 hover:bg-[rgba(212,168,75,0.05)]'
                  }`}
              >
                {/* Emoji icon box */}
                <div
                  ...
                  ${
                    isActive ? 'bg-[rgba(212,168,75,0.18)]' : 'bg-white/[0.05]'
                  }`}
                >
                  {cat.emoji}
                </div>
                ...
                <div>
                  <div
                    ...
                    ${isActive ? 'text-[#d4a84b]' : 'text-[#e8ecf4]'}`}
                  >
                    {cat.name}
                  </div>
                  <div className="text-[0.7rem] text-[#6b7694]">
                    {cat.count}
                  </div>
                </div>
              </button>
